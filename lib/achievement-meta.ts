...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  },
  {
    ...
    category: "match",
    icon: "clone-trooper",
    condition: "5+ sentry kills in a single match",
  ...
  },
  {
    ...
    condition: "50%+ DFA accuracy in a match (min 10 attempts)",
    metric: {
      type: "matchPredicate",
      test: (s) => s.dfa_attempts >= 10 && s.dfa_kills >= 0.5 * s.dfa_attempts,
    },
    threshold: 1,
    rarity: "rare",
    pending: true,
  ...
  },
  {
    ...
    ranks: [
      ...
      { threshold: 1000, rarity: "epic" },
      { threshold: 2000, rarity: "legendary" },
    ],
  },
  {
    id: "veteran",
  ...
  // -------------------------------------------------------------------- Streaks
  {
    ...
    condition: "Win 5 matches in a row",
  ...
  },
  {
    ...
    category: "streak",
    icon: "separatists",
    condition: "Win 8 matches in a row",
    metric: { type: "winStreak" },
    threshold: 8,
    rarity: "legendary",
  },
